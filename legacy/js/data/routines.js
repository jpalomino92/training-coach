...
(function () {
   ...
   * extra: { perSide, warn, compound }
   * `key` identifica el ejercicio para el historial y el progreso.
   */
  function E(key, name, sets, range, rir, rest, pose, muscle, cue, alt, extra) {
    ...
    return Object.assign({
      ...
      perSide: false, warn: '', compound: false
    }, extra || {});
  }
  ...
  const routinePrograms = {
    ...
    maleUpperLower: {
      ...
      safety: { requireAck: false, warnings: [] },
      ...
      days: [
        ...
        { id: 'TA', name: 'Torso A', focus: 'Fuerza en básicos', color: 'blue', exercises: [
          ...
          E('shoulder_press_db', 'Press militar con mancuernas', 3, '8-10', '2', 90, 'ohp', 'Deltoides', 'Abdomen firme, sin arquear la espalda. Sube hasta casi estirar.', 'Press de hombros en máquina', { compound: true }),
          ...
          E('lateral_raise', 'Elevaciones laterales', 3, '12-15', '1-2', 60, 'lateral', 'Deltoide lateral', 'Codos ligeramente flexionados. Sube hasta la altura del hombro.', 'Elevación lateral en polea'),
          E('curl_db', 'Curl de bíceps', 3, '10-12', '1-2', 60, 'curl', 'Bíceps', 'Codos quietos pegados al cuerpo. Puedes hacerlo en superserie con el tríceps.', 'Curl en polea baja'),
        ...
        { id: 'TB', name: 'Torso B', focus: 'Volumen e hipertrofia', color: 'green', exercises: [
          E('incline_db', 'Press inclinado con mancuernas', 4, '8-10', '2', 150, 'incline', 'Pectoral superior', 'Banco a 30°. Baja hasta sentir estirar el pecho.', 'Press inclinado en máquina', { compound: true }),
          ...
          E('hammer_curl', 'Curl martillo', 3, '10-12', '1-2', 60, 'curl', 'Bíceps y braquial', 'Agarre neutro, como sosteniendo un martillo.', 'Curl con cuerda en polea'),
    ...
    femaleFatLossMuscle: {
      ...
      days: [
        ...
        { id: 'F2', name: 'Día 2', focus: 'Espalda y postura', color: 'blue', exercises: [
          ...
          E('pullover_cable', 'Pullover en polea', 3, '12-15', '2', 60, 'pullup', 'Dorsales', 'Brazos casi estirados. Lleva la barra desde arriba hasta los muslos sin mover el tronco.', 'Pullover con mancuerna en banco'),
          ...
          E('curl_db', 'Curl de bíceps con mancuernas', 3, '10-12', '1-2', 60, 'curl', 'Bíceps', 'Codos quietos a los lados. Sube y baja controlado.', 'Curl en polea baja')
        ]},
        { id: 'F3', name: 'Día 3', focus: 'Pierna: cuádriceps', color: 'yellow', exercises: [
          ...
          E('reverse_lunge_db', 'Estocada trasera con mancuernas', 3, '10-12', '2', 90, 'walklunge', 'Cuádriceps y glúteo', 'Paso atrás largo y torso erguido. Empuja con el talón de la pierna delantera.', 'Estocada en Smith', { perSide: true }),
        ...
        { id: 'F4', name: 'Día 4', focus: 'Torso: empuje y espalda alta', color: 'green', exercises: [
          ...
          E('shoulder_press_db', 'Press de hombros sentada', 3, '8-12', '2', 90, 'ohp', 'Deltoides', 'Respaldo casi vertical, abdomen firme y sin arquear la espalda.', 'Press de hombros en máquina', { compound: true }),
          ...
          E('lateral_raise', 'Elevaciones laterales', 3, '12-15', '1-2', 60, 'lateral', 'Deltoide lateral', 'Codos un poco flexionados. Sube hasta la altura del hombro sin encoger el cuello.', 'Elevación lateral en polea'),
        ...
        { id: 'F5', name: 'Día 5', focus: 'Glúteo, espalda y core', color: 'black', exercises: [
          ...
          E('one_arm_row', 'Remo a un brazo con mancuerna', 3, '10-12', '2', 90, 'row', 'Dorsal', 'Mano y rodilla apoyadas en el banco, espalda plana. Lleva el codo hacia la cadera.', 'Remo unilateral en polea', { perSide: true }),
          ...
          E('farmer_walk', 'Paseo del granjero', 3, '30-40s', '2', 60, 'farmer', 'Core, trapecio y agarre', 'Mancuernas pesadas a los lados, hombros atrás y abajo. Camina erguida.', 'Sostener las mancuernas de pie'),
    ...
    femaleMenopauseSafeStrength: {
      ...
      days: [
        { id: 'SA', name: 'Día A', focus: 'Pierna y tracción', color: 'red', exercises: [
          E('leg_press', 'Prensa de piernas', 3, '10-12', '3', 120, 'legpress', 'Cuádriceps y glúteo', 'Baja solo hasta donde la pelvis y la zona lumbar siguen pegadas al respaldo. Empuja con todo el pie.', 'Sentarse y levantarse de un banco', { compound: true, warn: 'No hagas recorridos profundos si la zona lumbar se despega del respaldo o si notas dolor en rodilla o cadera.' }),
          E('leg_curl_seated', 'Curl femoral sentado', 3, '10-12', '2-3', 90, 'legcurl', 'Isquiotibiales', 'Espalda apoyada en el respaldo. Flexiona y vuelve lento en 3 segundos.', 'Curl femoral con banda, sentada'),
          E('lat_pulldown_neutral', 'Jalón al pecho agarre neutro', 3, '10-12', '2-3', 90, 'pullup', 'Dorsales', 'Sentada con los muslos sujetos. Lleva los codos hacia abajo sin echar el tronco atrás.', 'Jalón en máquina con apoyo de pecho', { compound: true }),
          E('machine_row_supported', 'Remo en máquina con apoyo de pecho', 3, '10-12', '2-3', 90, 'cablerow', 'Espalda media y alta', 'El apoyo de pecho quita carga a la zona lumbar. Lleva los codos atrás y junta las escápulas.', 'Remo sentado en polea con espalda erguida'),
          E('abductor_machine', 'Abductores en máquina', 2, '12-15', '2-3', 60, 'abductor', 'Glúteo medio', 'Espalda apoyada. Abre controlado en un rango cómodo para la cadera.', 'Abducción con banda, sentada'),
          E('dead_bug', 'Dead bug suave', 2, '6-8', '3', 60, 'deadbug', 'Core (estabilidad)', 'Empieza moviendo solo los brazos o solo las piernas. La zona lumbar se mantiene quieta y sin dolor.', 'Respiración abdominal tumbada con rodillas flexionadas', { perSide: true, warn: 'Si aparece dolor lumbar, detente y consulta la alternativa con tu fisioterapeuta.' })
        ]},
        { id: 'SB', name: 'Día B', focus: 'Glúteo y empuje', color: 'blue', exercises: [
          E('glute_bridge', 'Puente de glúteo', 3, '10-15', '3', 90, 'glutebridge', 'Glúteo mayor', 'Pies apoyados. Sube hasta alinear cadera y muslos apretando el glúteo, sin arquear la zona lumbar.', 'Hip thrust en máquina con carga ligera', { warn: 'Progresa de peso corporal a banda y después a un peso ligero sobre la cadera.' }),
          E('box_squat', 'Sentadilla a banco con mancuerna', 3, '8-12', '3', 120, 'boxsquat', 'Cuádriceps y glúteo', 'Mancuerna ligera al pecho. Siéntate controlada en un banco alto y levántate empujando el suelo.', 'Prensa de piernas', { compound: true, warn: 'Usa un banco a la altura que no genere dolor en rodillas ni cadera.' }),
          E('chest_press_machine', 'Press de pecho en máquina', 3, '10-12', '2-3', 90, 'chestpress', 'Pectoral y tríceps', 'Espalda apoyada en el respaldo. Empuja sin bloquear los codos.', 'Press con mancuernas en banco inclinado', { compound: true }),
          E('lateral_raise_seated', 'Elevaciones laterales sentada', 2, '12-15', '2-3', 60, 'lateral', 'Deltoide lateral', 'Sentada con respaldo y mancuernas ligeras. Sube hasta un poco por debajo del hombro.', 'Elevación lateral en polea'),
          E('face_pull', 'Face pull con banda o polea', 2, '12-15', '2-3', 60, 'facepull', 'Deltoide posterior y trapecio medio', 'De pie y erguida. Tira hacia la cara separando las manos.', 'Remo alto con banda, sentada'),
          E('triceps_rope', 'Tríceps en polea', 2, '12-15', '2', 60, 'pushdown', 'Tríceps', 'Codos pegados y tronco quieto.', 'Extensión de tríceps con banda'),
          E('incline_plank', 'Plancha inclinada', 3, '20-30s', '3', 60, 'plank', 'Core (anti-extensión)', 'Manos en un banco y cuerpo en línea. Cuanto más alta la superficie, más fácil.', 'Plancha contra la pared')
        ]},
        { id: 'SC', name: 'Día C', focus: 'Pierna y espalda', color: 'yellow', exercises: [
          E('leg_ext', 'Sillón de cuádriceps', 3, '10-15', '2-3', 90, 'legext', 'Cuádriceps', 'Sube controlado, pausa y baja lento, en un rango cómodo para la rodilla.', 'Extensión de rodilla con banda, sentada', { warn: 'Con artrosis de rodilla, trabaja solo en el recorrido que no genere dolor.' }),
          E('step_up', 'Subida a escalón bajo con apoyo', 2, '8-10', '3', 90, 'stepup', 'Cuádriceps y glúteo', 'Escalón bajo y una mano en un apoyo fijo. Sube empujando con el talón y baja despacio.', 'Prensa a una pierna con carga ligera', { perSide: true }),
          E('adductor_machine', 'Aductores en máquina', 2, '12-15', '2-3', 60, 'abductor', 'Aductores', 'Espalda apoyada. Cierra controlado.', 'Pelota apretada entre las rodillas, sentada'),
          E('cable_row', 'Remo sentado en polea', 3, '10-12', '2-3', 90, 'cablerow', 'Dorsales y romboides', 'Espalda erguida y fija; solo se mueven los brazos. Junta las escápulas al final.', 'Remo en máquina con apoyo de pecho', { compound: true, warn: 'No balancees el tronco adelante y atrás para mover el peso.' }),
          E('pec_deck', 'Aperturas en máquina', 2, '10-12', '2-3', 60, 'chestpress', 'Pectoral', 'Espalda apoyada. Cierra delante del pecho sin forzar los hombros.', 'Aperturas con banda'),
          E('curl_seated', 'Curl de bíceps sentada', 2, '10-12', '2', 60, 'curl', 'Bíceps', 'Espalda apoyada en el respaldo y codos quietos.', 'Curl en polea baja'),
          E('pallof', 'Pallof press', 2, '8-10', '3', 60, 'pallof', 'Core (anti-rotación)', 'De lado a la polea. Empuja al frente y resiste el giro sin rotar la columna.', 'Pallof con banda, sentada', { perSide: true })
        ]}
      ]
    }
  };
  ...
  // Índices útiles
  function findExercise(program, key) {
    for (const d of program.days) for (const e of d.exercises) if (e.key === key) return e;
    return null;
  }
  function findExerciseAnywhere(key) {
    for (const p of Object.values(routinePrograms)) { const e = findExercise(p, key); if (e) return e; }
    return null;
  }

  window.RoutineData = { routinePrograms, PAIN_GUIDE, findExercise, findExerciseAnywhere };
})();
